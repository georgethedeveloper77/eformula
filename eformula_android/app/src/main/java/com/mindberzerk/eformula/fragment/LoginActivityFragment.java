...
import com.mindberzerk.eformula.activity.MainActivity;
import com.mindberzerk.eformula.activity.PrivacyPolicy;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        loginrlyt.setOnClickListener(view -> {
            if (chkPrivacy.isChecked()) {
                ...
                Toast.makeText(getActivity(), "Please Accept our Privacy Policy!!", Toast.LENGTH_LONG).show();
            }
