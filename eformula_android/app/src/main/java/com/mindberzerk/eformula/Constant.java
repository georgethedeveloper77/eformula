...
public class Constant {
    ...
    private static String DOMAIN_URL = "https://eformula.000webhostapp.com/"; //domain or admin panel url
    public static String QUIZ_URL = DOMAIN_URL + "api-v2.php";  //api url
    /////// PARAMETERS  ///////
    public static String AUTHORIZATION = "Authorization";
    public static String JWT_KEY = "eyJhbGciOiJIUzI1NiJ9.eyJEYXRhYmFzZSBOYW1lIjoiZWZvcm11bGFfZGIiLCJVc2VybmFtZSI6InJvb3QiLCJEYXRhYmFzZSBIb3N0bmFtZSI6ImxvY2FsaG9zdCIsImV4cCI6MTY1Mjk3MTcxNywiaWF0IjoxNjUyOTcxNzE3fQ.3t0hboTTwaseMD0xOyx5nJzFnVyycEko2EgiXaUM7nY";
    ...
    public static String APP_LINK = "https://play.google.com/store/apps/details?id=com.mindberzerk.eformula";
    public static String MORE_APP_URL = "https://play.google.com/store/apps/dev?id=8965127905950081681";
